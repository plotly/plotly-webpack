# Bundling [plotly.js](https://github.com/plotly/plotly.js) for development or production with `webpack`
...
```bash
yarn install
yarn webpack-dev   #takes ~10s for a 5.9MB bundle
yarn webpack-prod  #takes ~60s for a 2.2MB bundle
open index.html
```
